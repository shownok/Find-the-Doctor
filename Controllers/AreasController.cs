...
namespace appweb.Controllers
{
    public class AreasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AreaId,AreaName,PhoneNo")] Area area)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AreaId,AreaName,PhoneNo")] Area area)
        {
            if (id != area.AreaId)
            {
                return NotFound();
