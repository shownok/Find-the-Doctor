...
namespace appweb.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,TreatmentDetails,DoctorId,PatientId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,TreatmentDetails,DoctorId,PatientId")] Appointment appointment)
        {
